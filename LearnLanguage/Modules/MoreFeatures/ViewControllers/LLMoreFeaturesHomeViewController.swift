//
//  LLMoreFeaturesHomeViewController.swift
//  LearnLanguage
//
//  学习实验室 - 更多功能首页
//
...
final class LLMoreFeaturesHomeViewController: NSViewController {
    ...
    private func setupUI() {
        ...
        backButton.contentTintColor = .systemOrange
        ...
        iconWrap.layer?.backgroundColor = NSColor.systemOrange.withAlphaComponent(0.12).cgColor
        ...
        iconView.image = NSImage(systemSymbolName: "sparkles.rectangle.stack.fill", accessibilityDescription: nil)
        ...
        let titleLabel = NSTextField(labelWithString: "更多功能")
        ...
        let subtitleLabel = NSTextField(labelWithString: "More Features")
